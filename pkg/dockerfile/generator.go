...
// - mwBase: The base image used for Dockerfile generation for model weights.
...
func (g *Generator) Generate() (mwBase string, dockerfile string, dockerignoreContents string, err error) {
