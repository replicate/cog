...
func TestCOGWheelDefaultCogRuntimeTrue(t *testing.T) {
	// cog_runtime: true is deprecated - now defaults to cog wheel
	t.Skip("cog_runtime flag is deprecated, coglet is selected via COG_WHEEL=coglet")
}
...
func TestCOGWheelEnvCoglet(t *testing.T) {
	// COG_WHEEL=coglet should install both cog wheel and coglet (Rust) wheel
...
`
	...
	// Should contain both cog and coglet wheel installs
	require.Contains(t, actual, "/tmp/cog-")
...
func TestCOGWheelEnvCogletAlpha(t *testing.T) {
	// coglet-alpha is no longer supported - use COG_WHEEL=coglet for Rust runtime
	t.Skip("coglet-alpha is deprecated, use COG_WHEEL=coglet for Rust runtime")
}
...
func TestCOGWheelEnvURLNonCoglet(t *testing.T) {
	// Merged into TestCOGWheelEnvURL - URL installs are now all treated the same
	t.Skip("URL install behavior consolidated into TestCOGWheelEnvURL")
}
