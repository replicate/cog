...
// TODO(neville): Fetch this from cog repository proxy
//
//go:embed baseimage_configurations.json
var baseImageConfigurationData []byte
...
func BaseImageConfigurations() []BaseImageConfiguration {
	...
	var list []BaseImageConfiguration
	if err := json.Unmarshal(baseImageConfigurationData, &list); err != nil {
		console.Fatalf("Failed to load base image configurations: %s", err)
	}
	return list
}
