...
// NewMockPushResultCommand2 creates a new instance of MockPushResultCommand2. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockPushResultCommand2(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockPushResultCommand2 {
	mock := &MockPushResultCommand2{}
	mock.Mock.Test(t)
...
// MockPushResultCommand2 is an autogenerated mock type for the PushResultCommand type
type MockPushResultCommand2 struct {
	mock.Mock
}

type MockPushResultCommand2_Expecter struct {
	mock *mock.Mock
}

func (_m *MockPushResultCommand2) EXPECT() *MockPushResultCommand2_Expecter {
	return &MockPushResultCommand2_Expecter{mock: &_m.Mock}
}

// PushWithResult provides a mock function for the type MockPushResultCommand2
func (_mock *MockPushResultCommand2) PushWithResult(ctx context.Context, ref string) (command.PushResult, error) {
	ret := _mock.Called(ctx, ref)

	if len(ret) == 0 {
		panic("no return value specified for PushWithResult")
	}

	var r0 command.PushResult
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (command.PushResult, error)); ok {
		return returnFunc(ctx, ref)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) command.PushResult); ok {
		r0 = returnFunc(ctx, ref)
	} else {
		r0 = ret.Get(0).(command.PushResult)
	}
...
// MockPushResultCommand2_PushWithResult_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PushWithResult'
type MockPushResultCommand2_PushWithResult_Call struct {
	*mock.Call
}

// PushWithResult is a helper method to define mock.On call
//   - ctx context.Context
//   - ref string
func (_e *MockPushResultCommand2_Expecter) PushWithResult(ctx interface{}, ref interface{}) *MockPushResultCommand2_PushWithResult_Call {
	return &MockPushResultCommand2_PushWithResult_Call{Call: _e.mock.On("PushWithResult", ctx, ref)}
}

func (_c *MockPushResultCommand2_PushWithResult_Call) Run(run func(ctx context.Context, ref string)) *MockPushResultCommand2_PushWithResult_Call {
...
func (_c *MockPushResultCommand2_PushWithResult_Call) Return(pushResult command.PushResult, err error) *MockPushResultCommand2_PushWithResult_Call {
	_c.Call.Return(pushResult, err)
	return _c
}

func (_c *MockPushResultCommand2_PushWithResult_Call) RunAndReturn(run func(ctx context.Context, ref string) (command.PushResult, error)) *MockPushResultCommand2_PushWithResult_Call {
	_c.Call.Return(run)
	return _c
}
