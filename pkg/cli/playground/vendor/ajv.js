...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t, n) => () => {
	...
	function f(e, t, n = {}) {
		let { gen: r, it: i } = e, a = [p(i, n), _(e, n)];
	...
	var t = _(), n = m(), r = g(), i = { message: "boolean schema is false" };
	function a(e) {
	...
	function l(e, t) {
		...
		if (c) {
			let n = v(t, i, a.strictNumbers, o.Wrong);
			r.if(n, () => {
	...
	function f(e, t, n) {
		...
		o.coerceTypes === "array" && r.if((0, i._)`${s} == 'object' && Array.isArray(${a}) && ${a}.length == 1`, () => r.assign(a, (0, i._)`${a}[0]`).assign(s, (0, i._)`typeof ${a}`).if(v(t, a, o.strictNumbers), () => r.assign(c, a))), r.if((0, i._)`${c} !== undefined`);
	...
	e.checkDataType = g;
	function v(e, t, n, r) {
		if (e.length === 1) return g(e[0], t, n, r);
		...
		for (let e in s) o = (0, i.and)(o, g(e, t, n, r));
		return o;
	}
	e.checkDataTypes = v;
	var x = {
	...
	var t = h(), n = E(), r = D(), i = /* @__PURE__ */ new Set([
		"type",
		"format",
		"pattern",
		"maxLength",
	...
	var t = v(), n = x(), r = b(), i = x(), a = S(), o = w(), s = T(), c = m(), l = g(), u = O(), d = h(), f = _();
	function p(e) {
		if (N(e) && (F(e), M(e))) {
			D(e);
			return;
		}
		y(e, () => (0, t.topBoolOrEmptySchema)(e));
	}
	e.validateFunctionCode = p;
	function y({ gen: e, validateName: t, schema: n, schemaEnv: r, opts: i }, a) {
		i.code.es5 ? e.func(t, (0, c._)`${l.default.data}, ${l.default.valCxt}`, r.$async, () => {
			e.code((0, c._)`"use strict"; ${A(n, i)}`), E(e, i), e.code(a);
		}) : e.func(t, (0, c._)`${l.default.data}, ${C(i)}`, r.$async, () => e.code(A(n, i)).code(a));
	}
	function C(e) {
	...
	function D(e) {
		...
		y(e, () => {
			n.$comment && t.$comment && B(e), R(e), r.let(l.default.vErrors, null), r.let(l.default.errors, 0), n.unevaluated && k(e), I(e), te(e);
		});
	}
	function k(e) {
	...
	function P(e, t) {
		...
		i.$comment && n.$comment && B(e), z(e), ee(e);
	...
	function te(e) {
		...
		n.$async ? t.if((0, c._)`${l.default.errors} === 0`, () => t.return(l.default.data), () => t.throw((0, c._)`new ${i}(${l.default.vErrors})`)) : (t.assign((0, c._)`${r}.errors`, l.default.vErrors), a.unevaluated && V(e), t.return((0, c._)`${l.default.errors} === 0`));
	}
	function V({ gen: e, evaluated: t, props: n, items: r }) {
	...
	function H(e, t, n, a) {
		...
		if (s.$ref && (p.ignoreKeywordsWithRef || !(0, d.schemaHasRulesButRef)(s, h))) {
			o.block(() => Z(e, "$ref", h.all.$ref.definition));
			return;
		}
		p.jtd || W(e, t), o.block(() => {
	...
	function U(e, t) {
		...
		o && (0, a.assignDefaults)(e, t.type), n.block(() => {
			for (let n of t.rules) (0, r.shouldUseRule)(i, n) && Z(e, n.keyword, n.definition, t.type);
		});
	}
	function W(e, t) {
		e.schemaEnv.meta || !e.opts.strictTypes || (G(e, t), e.opts.allowUnionTypes || K(e, t), ne(e, e.dataTypes));
	}
	function G(e, t) {
		if (t.length) {
			...
			t.forEach((t) => {
				J(e.dataTypes, t) || Y(e, `type "${t}" not allowed by context "${e.dataTypes.join(",")}"`);
			}), re(e, t);
		}
	}
	function K(e, t) {
		t.length > 1 && !(t.length === 2 && t.includes("null")) && Y(e, "use allowUnionTypes to allow union type keyword");
	}
	function ne(e, t) {
		...
		for (let i in n) {
			...
			if (typeof a == "object" && (0, r.shouldUseRule)(e.schema, a)) {
				...
				n.length && !n.some((e) => q(t, e)) && Y(e, `missing type "${n.join(",")}" for keyword "${i}"`);
			}
		}
	}
	function q(e, t) {
	...
	function re(e, t) {
		let n = [];
		for (let r of e.dataTypes) J(t, r) ? n.push(r) : t.includes("integer") && r === "number" && n.push("integer");
		e.dataTypes = n;
	}
	function Y(e, t) {
	...
	var t = m(), n = A(), r = g(), i = O(), a = h(), o = k(), s = class {
		constructor(e) {
	...
	P = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", F = "Meta-schema for $data reference (JSON AnySchema extension proposal)", I = "object", L = ["$data"], R = { $data: {
		type: "string",
	...
	var { normalizeIPv6: n, removeDotSegments: r, recomposeAuthority: i, normalizePercentEncoding: a, normalizePathEncoding: o, escapePreservingEscapes: s, reescapeHostDelimiters: c, isIPv4: l, nonSimpleDomain: u } = B(), { SCHEMES: d, getSchemeHandler: f } = te();
	function p(e, t) {
	...
	var r = A(), i = j(), a = y(), o = M(), s = m(), c = O(), l = x(), u = h(), f = (ee(), d(N).default), p = H(), g = (e, t) => new RegExp(e, t);
	g.code = "new RegExp";
	var _ = [
		"removeAdditional",
		"useDefaults",
	...
	function w(e) {
		let t = e.strict, n = e.code?.optimize, r = n === !0 || n === void 0 ? 1 : n || 0, i = e.code?.regExp ?? g, a = e.uriResolver ?? p.default;
		return {
			...
			loopRequired: e.loopRequired ?? C,
			loopEnum: e.loopEnum ?? C,
			meta: e.meta ?? !0,
	...
	var T = class {
		constructor(e = {}) {
			...
			e.validateFormats = !1, this.RULES = (0, a.getRules)(), E.call(this, b, e, "NOT SUPPORTED"), E.call(this, S, e, "DEPRECATED", "warn"), this._metaOpts = L.call(this), e.formats && F.call(this), this._addVocabularies(), this._addDefaultMetaSchema(), e.keywords && I.call(this, e.keywords), typeof e.meta == "object" && this.addMetaSchema(e.meta), P.call(this), e.validateFormats = r;
		}
		_addVocabularies() {
		...
		addKeyword(e, t) {
			...
			if (te.call(this, n, t), !t) return (0, u.eachItem)(n, (e) => V.call(this, e)), this;
			W.call(this, t);
			let r = {
				...t,
	...
	function W(e) {
		let { metaSchema: t } = e;
		t !== void 0 && (e.$data && this.opts.$data && (t = K(t)), e.validateSchema = this.compile(t, !0));
	}
	var G = { $ref: "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#" };
	function K(e) {
		return { anyOf: [e, G] };
	}
})), W = /* @__PURE__ */ s(((e) => {
	Object.defineProperty(e, "__esModule", { value: !0 }), e.callRef = e.getValidate = void 0;
	var t = j(), n = C(), r = m(), i = g(), a = M(), o = h(), s = {
		keyword: "$ref",
		schemaType: "string",
		code(e) {
	...
	var t = U(), n = m().operators, r = {
		...
		$data: !0,
		error: {
			message: (e) => t.str`must be ${a(e).okStr} ${e.schemaCode}`,
			params: (e) => t._`{comparison: ${a(e).okStr}, limit: ${e.schemaCode}}`
		},
		code(e) {
			let { data: n, schemaCode: r } = e;
			e.fail$data(t._`${n} ${a(e).fail} ${r} || isNaN(${n})`);
		}
	};
	function a(e) {
		let t = e.keyword, n = +!!e.parentSchema?.[r[t].exclusive];
		return r[t].ops[n];
	}
	e.default = i;
})), ne = /* @__PURE__ */ s(((e) => {
	...
	e.default = {
		...
		type: "number",
		schemaType: "boolean",
		code({ keyword: e, parentSchema: n }) {
			let r = t[e];
			if (n[r] === void 0) throw Error(`${e} can only be used with ${r}`);
		}
	};
})), q = /* @__PURE__ */ s(((e) => {
	Object.defineProperty(e, "__esModule", { value: !0 });
	...
	Object.defineProperty(e, "__esModule", { value: !0 });
	var t = K(), n = ne(), r = q(), i = re(), a = Y(), o = X(), s = Z(), c = ie(), l = $(), u = ae(), d = oe();
	e.default = [
		t.default,
		n.default,
		r.default,
	...
	Object.defineProperty(e, "__esModule", { value: !0 });
	var t = ce(), n = ue(), r = le(), i = de(), a = fe(), o = pe(), s = me(), c = he(), l = ge(), u = _e(), d = ve(), f = ye(), p = be(), m = xe(), h = Se(), g = Ce();
	function _(e = !1) {
		let _ = [
			d.default,
			f.default,
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), e.default = [Te().default];
})), De = /* @__PURE__ */ s(((e) => {
	Object.defineProperty(e, "__esModule", { value: !0 });
	var t = G(), n = se(), r = we(), i = Ee();
	e.default = [
		t.default,
		n.default,
		r.default(),
	...
	properties: () => Ie,
	type: () => Fe
}), je, Me, Ne, Pe, Fe, Ie, Le, Re, ze = o((() => {
	je = "http://json-schema.org/draft-04/schema#", Me = "http://json-schema.org/draft-04/schema#", Ne = "Core schema meta-schema", Pe = {
		schemaArray: {
			type: "array",
			minItems: 1,
			items: { $ref: "#" }
	...
	Object.defineProperty(e, "__esModule", { value: !0 }), e.CodeGen = e.Name = e.nil = e.stringify = e.str = e._ = e.KeywordCxt = void 0;
	var n = U(), r = De(), i = ke(), a = (ze(), d(Ae).default), o = ["/properties"], s = "http://json-schema.org/draft-04/schema", c = class extends n.default {
		constructor(e = {}) {
			super({
				...e,
				schemaId: "id"
	...
	Object.defineProperty(e, "__esModule", { value: !0 });
	var t = We(), n = q(), r = re(), i = Y(), a = X(), o = Z(), s = ie(), c = $(), l = ae(), u = oe();
	e.default = [
		t.default,
		n.default,
		r.default,
	...
	title: () => Ze,
	type: () => $e
}), Ye, Xe, Ze, Qe, $e, et, tt, nt = o((() => {
	Ye = "http://json-schema.org/draft-07/schema#", Xe = "http://json-schema.org/draft-07/schema#", Ze = "Core schema meta-schema", Qe = {
		schemaArray: {
			type: "array",
			minItems: 1,
			items: { $ref: "#" }
	...
	var n = U(), r = qe(), i = ke(), a = (nt(), d(Je).default), o = ["/properties"], s = "http://json-schema.org/draft-07/schema", c = class extends n.default {
		_addVocabularies() {
			super._addVocabularies(), r.default.forEach((e) => this.addVocabulary(e)), this.opts.discriminator && this.addKeyword(i.default);
		}
		_addDefaultMetaSchema() {
	...
	Object.defineProperty(e, "__esModule", { value: !0 });
	var n = Ve(), r = it(), i = m(), a = new i.Name("fullFormats"), o = new i.Name("fastFormats"), s = (e, t = { keywords: !0 }) => {
...
})), ot = /* @__PURE__ */ u(Be(), 1), st = /* @__PURE__ */ u(at(), 1), ct = ot.default, lt = st.default;
export { ct as Ajv, lt as addFormats };
