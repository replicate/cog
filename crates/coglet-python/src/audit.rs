...
mod tests {
    ...
    #[test]
    fn hook_installed_flag_starts_false() {
        // Note: Can't test actual installation without Python runtime
        // This just verifies the atomic flag initial state
        // (but it may have been set by other tests)
    }
}
