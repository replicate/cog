...
import type { RequestTrace } from "../../domain/types";
...
const trace: RequestTrace = {
  ...
  events: [
    ...
    { id: "2", elapsedMs: 100, kind: "sse" as const, label: "output", data: "one" },
    { id: "3", elapsedMs: 200, kind: "sse" as const, label: "output", data: "two" },
  ],
};
