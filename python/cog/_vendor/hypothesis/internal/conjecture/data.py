...
from cog._vendor.hypothesis.errors import Frozen, InvalidArgument, StopTest
from cog._vendor.hypothesis.internal.compat import int_from_bytes, int_to_bytes
from cog._vendor.hypothesis.internal.conjecture.junkdrawer import IntList, uniform
from cog._vendor.hypothesis.internal.conjecture.utils import calc_label_from_name

if TYPE_CHECKING:
    from cog._vendor.typing_extensions import dataclass_transform

    from cog._vendor.hypothesis.strategies import SearchStrategy
    from cog._vendor.hypothesis.strategies._internal.strategies import Ex
else:
