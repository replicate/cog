...
from cog._vendor.hypothesis.internal.compat import int_from_bytes, int_to_bytes
from cog._vendor.hypothesis.internal.conjecture.choicetree import (
    ChoiceTree,
    prefix_selection_order,
    random_selection_order,
)
from cog._vendor.hypothesis.internal.conjecture.data import ConjectureResult, Status
from cog._vendor.hypothesis.internal.conjecture.floats import (
    DRAW_FLOAT_LABEL,
    float_to_lex,
    lex_to_float,
)
from cog._vendor.hypothesis.internal.conjecture.junkdrawer import (
    binary_search,
    find_integer,
    replace_all,
)
from cog._vendor.hypothesis.internal.conjecture.shrinking import Float, Integer, Lexical, Ordering
from cog._vendor.hypothesis.internal.conjecture.shrinking.learned_dfas import SHRINKING_DFAS
    ...
    * It's often worth trying one or two special minimal values
    ...
    def reorder_examples(self, chooser):
        ...
        .. code-block:: python
            ...
            import cog._vendor.hypothesis.strategies as st
            from cog._vendor.hypothesis import given
