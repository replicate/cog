...
from cog._vendor.hypothesis.errors import HypothesisException
from cog._vendor.hypothesis.internal.conjecture.data import ConjectureResult, Status
from cog._vendor.hypothesis.internal.conjecture.dfa.lstar import LStar
from cog._vendor.hypothesis.internal.conjecture.shrinking.learned_dfas import (
    SHRINKING_DFAS,
...
def learn_a_new_dfa(runner, u, v, predicate):
    ...
    this function."""
    from cog._vendor.hypothesis.internal.conjecture.shrinker import dfa_replacement, sort_key
...
def normalize(
    ...
    *,
    ...
    from cog._vendor.hypothesis.internal.conjecture.engine import BUFFER_SIZE, ConjectureRunner
