...
from cog._vendor.hypothesis import HealthCheck, Phase, Verbosity, settings as Settings
from cog._vendor.hypothesis._settings import local_settings
from cog._vendor.hypothesis.errors import StopTest
from cog._vendor.hypothesis.internal.cache import LRUReusedCache
from cog._vendor.hypothesis.internal.compat import ceil, int_from_bytes
from cog._vendor.hypothesis.internal.conjecture.data import (
    ConjectureData,
    ConjectureResult,
    DataObserver,
    Overrun,
...
from cog._vendor.hypothesis.internal.conjecture.datatree import (
    DataTree,
    PreviouslyUnseenBehaviour,
    TreeRecordingObserver,
)
from cog._vendor.hypothesis.internal.conjecture.junkdrawer import clamp, stack_depth_of_caller
from cog._vendor.hypothesis.internal.conjecture.pareto import NO_SCORE, ParetoFront, ParetoOptimiser
from cog._vendor.hypothesis.internal.conjecture.shrinker import Shrinker, sort_key
from cog._vendor.hypothesis.internal.healthcheck import fail_health_check
from cog._vendor.hypothesis.reporting import base_report, report
...
class ConjectureRunner:
    ...
    def optimise_targets(self):
        ...
        if not self.should_optimise:
            return
        from cog._vendor.hypothesis.internal.conjecture.optimiser import Optimiser
