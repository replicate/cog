...
if typing.TYPE_CHECKING:  # pragma: no cover
    from cog._vendor.typing_extensions import Concatenate as Concatenate, ParamSpec as ParamSpec
else:
    try:
        from typing import Concatenate as Concatenate, ParamSpec as ParamSpec
    except ImportError:
        try:
            from cog._vendor.typing_extensions import (
...
def get_type_hints(thing):
    ...
    if isinstance(thing, partial):
        from cog._vendor.hypothesis.internal.reflection import get_signature
    ...
    try:
        if hasattr(thing, "__signature__"):
            ...
            from cog._vendor.hypothesis.internal.reflection import get_signature
            from cog._vendor.hypothesis.strategies._internal.types import is_a_type
...
def bad_django_TestCase(runner):
    if runner is None or "django.test" not in sys.modules:
        ...
        from cog._vendor.hypothesis.extra.django._impl import HypothesisTestCase
