...
from cog._vendor.hypothesis.internal.compat import PYPY, is_typed_named_tuple, update_code_location
from cog._vendor.hypothesis.utils.conventions import not_set
from cog._vendor.hypothesis.vendor.pretty import pretty

if TYPE_CHECKING:
    from cog._vendor.hypothesis.strategies._internal.strategies import T
...
def get_signature(
    ...
    if sys.version_info[:2] <= (3, 8) and inspect.isclass(target):
        ...
        from cog._vendor.hypothesis.strategies._internal.types import is_generic_type
