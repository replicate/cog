...
from cog._vendor.hypothesis.configuration import mkdir_p, storage_directory
from cog._vendor.hypothesis.errors import HypothesisException, HypothesisWarning
