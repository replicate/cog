...
from cog._vendor.hypothesis import Verbosity, find, settings, strategies as st
from cog._vendor.hypothesis.errors import InvalidArgument
from cog._vendor.hypothesis.internal.compat import get_args, get_origin, get_type_hints
from cog._vendor.hypothesis.internal.reflection import get_signature, is_mock
from cog._vendor.hypothesis.internal.validation import check_type
from cog._vendor.hypothesis.provisional import domains
from cog._vendor.hypothesis.strategies._internal.collections import ListStrategy
from cog._vendor.hypothesis.strategies._internal.core import BuildsStrategy
from cog._vendor.hypothesis.strategies._internal.flatmapped import FlatMapStrategy
...
from cog._vendor.hypothesis.strategies._internal.types import _global_type_lookup, is_generic_type
...
def fuzz(
    ...
    *,
    ...
    .. code-block:: python
        ...
        from cog._vendor.hypothesis.extra import ghostwriter
    ...
    .. code-block:: python
        ...
        from cog._vendor.hypothesis import given, reject, strategies as st
...
def idempotent(
    ...
    *,
    ...
    .. code-block:: python
        ...
        from cog._vendor.hypothesis import given, strategies as st
...
def _make_ufunc_body(func, *, except_, style, annotate):
    import cog._vendor.hypothesis.extra.numpy as npst
