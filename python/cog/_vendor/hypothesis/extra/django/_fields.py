...
from cog._vendor.hypothesis.provisional import urls
from cog._vendor.hypothesis.strategies import emails
...
def timezones():
    ...
    if getattr(django.conf.settings, "USE_DEPRECATED_PYTZ", True):
        from cog._vendor.hypothesis.extra.pytz import timezones
    else:
        from cog._vendor.hypothesis.strategies import timezones
