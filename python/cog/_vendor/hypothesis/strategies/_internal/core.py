...
from cog._vendor import attr

from cog._vendor.hypothesis._settings import note_deprecation
from cog._vendor.hypothesis.control import cleanup, current_build_context, note
from cog._vendor.hypothesis.errors import InvalidArgument, ResolutionFailed
from cog._vendor.hypothesis.internal.cathetus import cathetus
from cog._vendor.hypothesis.internal.charmap import as_general_categories
from cog._vendor.hypothesis.internal.compat import (
    Concatenate,
    ParamSpec,
    ceil,
    floor,
...
from cog._vendor.hypothesis.internal.conjecture.utils import (
    calc_label_from_cls,
    check_sample,
    integer_range,
)
from cog._vendor.hypothesis.internal.entropy import get_seeder_and_restorer
from cog._vendor.hypothesis.internal.reflection import (
...
from cog._vendor.hypothesis.internal.validation import (
    check_type,
    check_valid_integer,
...
from cog._vendor.hypothesis.strategies._internal import SearchStrategy, check_strategy
from cog._vendor.hypothesis.strategies._internal.collections import (
...
from cog._vendor.hypothesis.strategies._internal.deferred import DeferredStrategy
from cog._vendor.hypothesis.strategies._internal.functions import FunctionStrategy
from cog._vendor.hypothesis.strategies._internal.lazy import LazyStrategy, unwrap_strategies
from cog._vendor.hypothesis.strategies._internal.misc import just, none, nothing
from cog._vendor.hypothesis.strategies._internal.numbers import (
    IntegersStrategy,
    Real,
    floats,
    integers,
)
from cog._vendor.hypothesis.strategies._internal.recursive import RecursiveStrategy
from cog._vendor.hypothesis.strategies._internal.shared import SharedStrategy
from cog._vendor.hypothesis.strategies._internal.strategies import (
    Ex,
    SampledFromStrategy,
    T,
    one_of,
)
from cog._vendor.hypothesis.strategies._internal.strings import (
    FixedSizeBytes,
    OneCharStringStrategy,
    TextStrategy,
)
from cog._vendor.hypothesis.strategies._internal.utils import cacheable, defines_strategy
from cog._vendor.hypothesis.utils.conventions import not_set
from cog._vendor.hypothesis.vendor.pretty import RepresentationPrinter
...
def from_regex(
    ...
    from cog._vendor.hypothesis.strategies._internal.regex import regex_strategy
...
def randoms(
    *,
    ...
    from cog._vendor.hypothesis.strategies._internal.random import RandomStrategy
    ...
    **kwargs: Union[SearchStrategy[Any], EllipsisType],
    ...
    if required or to_infer:
        if isinstance(target, type) and attr.has(target):
            ...
            from cog._vendor.hypothesis.strategies._internal.attrs import from_attrs
        ...
        if infer_for:
            from cog._vendor.hypothesis.strategies._internal.types import _global_type_lookup
...
def _from_type(thing: Type[Ex]) -> SearchStrategy[Ex]:
    # TODO: We would like to move this to the top level, but pending some major
    # refactoring it's hard to do without creating circular imports.
    from cog._vendor.hypothesis.strategies._internal import types
...
def domains():
    import cog._vendor.hypothesis.provisional as provisional
