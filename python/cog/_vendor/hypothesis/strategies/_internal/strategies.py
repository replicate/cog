...
from cog._vendor.hypothesis.control import _current_build_context, assume
...
from cog._vendor.hypothesis.internal.conjecture.data import ConjectureData
from cog._vendor.hypothesis.internal.conjecture.utils import (
    calc_label_from_cls,
    calc_label_from_name,
    combine_labels,
)
from cog._vendor.hypothesis.internal.coverage import check_function
from cog._vendor.hypothesis.internal.lazyformat import lazyformat
from cog._vendor.hypothesis.internal.reflection import (
    get_pretty_function_description,
    is_identity_function,
)
from cog._vendor.hypothesis.strategies._internal.utils import defines_strategy
from cog._vendor.hypothesis.utils.conventions import UniqueIdentifier
...
class SearchStrategy(Generic[Ex]):
    ...
    def example(self) -> Ex:
        ...
        from cog._vendor.hypothesis.core import given
