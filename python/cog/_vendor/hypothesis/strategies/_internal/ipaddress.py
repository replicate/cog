...
from cog._vendor.hypothesis.strategies._internal.core import binary, sampled_from
from cog._vendor.hypothesis.strategies._internal.numbers import integers
