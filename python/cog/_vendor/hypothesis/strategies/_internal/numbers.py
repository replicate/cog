...
from cog._vendor.hypothesis.control import reject
from cog._vendor.hypothesis.errors import InvalidArgument
from cog._vendor.hypothesis.internal.conjecture import floats as flt, utils as d
from cog._vendor.hypothesis.internal.conjecture.utils import calc_label_from_name
from cog._vendor.hypothesis.internal.filtering import (
    get_float_predicate_bounds,
    get_integer_predicate_bounds,
)
from cog._vendor.hypothesis.internal.floats import (
    float_of,
    float_to_int,
    int_to_float,
    is_negative,
...
def floats(
    ...
    *,
    ...
    if allow_subnormal and next_up(0.0, width=width) == 0:  # pragma: no cover
        ...
        from cog._vendor._hypothesis_ftz_detector import identify_ftz_culprits
