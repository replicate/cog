...
from cog._vendor.hypothesis.internal.compat import PYPY, BaseExceptionGroup, ExceptionGroup
from cog._vendor.hypothesis.internal.conjecture.utils import many as conjecture_utils_many
from cog._vendor.hypothesis.strategies._internal.datetime import zoneinfo  # type: ignore
from cog._vendor.hypothesis.strategies._internal.ipaddress import (
    SPECIAL_IPv4_RANGES,
    SPECIAL_IPv6_RANGES,
    ip_addresses,
)
from cog._vendor.hypothesis.strategies._internal.lazy import unwrap_strategies
from cog._vendor.hypothesis.strategies._internal.strategies import OneOfStrategy
...
try:
    from cog._vendor import typing_extensions
except ImportError:
...
try:
    ...
    try:
        from cog._vendor.typing_extensions import _AnnotatedAlias
    except ImportError:
        _AnnotatedAlias = ()
...
try:  # pragma: no cover
    ...
    from cog._vendor.hypothesis.extra.numpy import array_dtypes, array_shapes, arrays, scalar_dtypes
