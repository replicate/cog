...
from cog._vendor.hypothesis.internal.floats import float_to_int
from cog._vendor.hypothesis.internal.reflection import proxies

if TYPE_CHECKING:
    from cog._vendor.hypothesis.strategies._internal.strategies import SearchStrategy, T
...
def defines_strategy(
    *,
    ...
    def decorator(strategy_definition):
        ...
        from cog._vendor.hypothesis.strategies._internal.lazy import LazyStrategy
