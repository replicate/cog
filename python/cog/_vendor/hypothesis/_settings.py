...
from cog._vendor.hypothesis.internal.validation import check_type, try_convert
...
if TYPE_CHECKING:
    from cog._vendor.hypothesis.database import ExampleDatabase
...
class settings(metaclass=settingsMeta):
    ...
    def __call__(self, test: T) -> T:
        ...
        if inspect.isclass(test):
            from cog._vendor.hypothesis.stateful import RuleBasedStateMachine
