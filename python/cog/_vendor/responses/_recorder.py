...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from cog._vendor.responses import FirstMatchRegistry
    from cog._vendor.responses import HTTPAdapter
    from cog._vendor.responses import PreparedRequest
    from cog._vendor.responses import models
    from cog._vendor.responses import _F
    from cog._vendor.responses import BaseResponse

    from io import TextIOWrapper

from cog._vendor import yaml

from cog._vendor.responses import RequestsMock
from cog._vendor.responses import Response
from cog._vendor.responses import _real_send
from cog._vendor.responses.registries import OrderedRegistry
