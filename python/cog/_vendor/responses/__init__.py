...
from cog._vendor import yaml
from cog._vendor.requests.adapters import HTTPAdapter
from cog._vendor.requests.adapters import MaxRetryError
from cog._vendor.requests.exceptions import ConnectionError
from cog._vendor.requests.exceptions import RetryError

from cog._vendor.responses.matchers import json_params_matcher as _json_params_matcher
from cog._vendor.responses.matchers import query_string_matcher as _query_string_matcher
from cog._vendor.responses.matchers import urlencoded_params_matcher as _urlencoded_params_matcher
from cog._vendor.responses.registries import FirstMatchRegistry

try:
    from cog._vendor.typing_extensions import Literal
except ImportError:  # pragma: no cover
    from typing import Literal  # type: ignore  # pragma: no cover

try:
    from cog._vendor.requests.packages.urllib3.response import HTTPResponse
except ImportError:  # pragma: no cover
    from cog._vendor.urllib3.response import HTTPResponse  # pragma: no cover

try:
    from cog._vendor.requests.packages.urllib3.connection import HTTPHeaderDict
except ImportError:  # pragma: no cover
    from cog._vendor.urllib3.response import HTTPHeaderDict  # type: ignore[attr-defined]
try:
    from cog._vendor.requests.packages.urllib3.util.url import parse_url
except ImportError:  # pragma: no cover
    from cog._vendor.urllib3.util.url import parse_url  # pragma: no cover
...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from cog._vendor.requests import models
    from cog._vendor.urllib3 import Retry as _Retry
