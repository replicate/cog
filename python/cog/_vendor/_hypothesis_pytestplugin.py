...
class StoringReporter:
    def __init__(self, config):
        ...
        from cog._vendor.hypothesis.reporting import default
...
if tuple(map(int, pytest.__version__.split(".")[:2])) < (4, 6):  # pragma: no cover
    ...
    def pytest_configure(config):
        ...
        if not _any_hypothesis_option(config):
            return
        from cog._vendor.hypothesis import Phase, Verbosity, core, settings
    ...
    def pytest_runtest_call(item):
        ...
        from cog._vendor.hypothesis import core
        from cog._vendor.hypothesis.internal.detection import is_hypothesis_test
        ...
        if not is_hypothesis_test(item.obj):
            ...
            from cog._vendor.hypothesis import HealthCheck, settings
            from cog._vendor.hypothesis.internal.escalation import current_pytest_item
            from cog._vendor.hypothesis.internal.healthcheck import fail_health_check
            from cog._vendor.hypothesis.reporting import with_reporter
            from cog._vendor.hypothesis.statistics import collector, describe_statistics
