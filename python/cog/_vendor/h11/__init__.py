...
from cog._vendor.h11._connection import Connection, NEED_DATA, PAUSED
from cog._vendor.h11._events import (
    ConnectionClosed,
    Data,
    EndOfMessage,
    Event,
...
from cog._vendor.h11._state import (
    CLIENT,
    CLOSED,
    DONE,
    ERROR,
...
from cog._vendor.h11._util import LocalProtocolError, ProtocolError, RemoteProtocolError
from cog._vendor.h11._version import __version__
