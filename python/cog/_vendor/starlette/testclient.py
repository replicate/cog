...
import cog._vendor.anyio.from_thread as from_thread
from cog._vendor import httpx
from cog._vendor.anyio.streams.stapled import StapledObjectStream

from cog._vendor.starlette._utils import is_async_callable
from cog._vendor.starlette.types import ASGIApp, Message, Receive, Scope, Send
from cog._vendor.starlette.websockets import WebSocketDisconnect

if sys.version_info >= (3, 8):  # pragma: no cover
    from typing import TypedDict
else:  # pragma: no cover
    from cog._vendor.typing_extensions import TypedDict
    ...
    def __enter__(self) -> "TestClient":
        with contextlib.ExitStack() as stack:
            self.portal = portal = stack.enter_context(
                from_thread.start_blocking_portal(**self.async_backend)
            )
