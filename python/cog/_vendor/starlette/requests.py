...
from cog._vendor.starlette._utils import AwaitableOrContextManager, AwaitableOrContextManagerWrapper
from cog._vendor.starlette.datastructures import URL, Address, FormData, Headers, QueryParams, State
from cog._vendor.starlette.exceptions import HTTPException
from cog._vendor.starlette.formparsers import FormParser, MultiPartException, MultiPartParser
from cog._vendor.starlette.types import Message, Receive, Scope, Send
...
if typing.TYPE_CHECKING:
    from cog._vendor.starlette.routing import Router
