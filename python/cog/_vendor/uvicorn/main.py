...
from cog._vendor import uvicorn
from cog._vendor.uvicorn.config import (
    HTTP_PROTOCOLS,
    INTERFACES,
    LIFESPAN,
    LOG_LEVELS,
...
from cog._vendor.uvicorn.server import Server, ServerState  # noqa: F401  # Used to be defined here.
from cog._vendor.uvicorn.supervisors import ChangeReload, Multiprocess
