...
if TYPE_CHECKING:
    ...
    from cog._vendor.uvicorn.protocols.websockets.websockets_impl import WebSocketProtocol
    from cog._vendor.uvicorn.protocols.websockets.wsproto_impl import WSProtocol
