...
class PredictionService:
    ...
    def __init__(
        ...
        *,
        worker: Worker,
        _setup_task_cls: Optional[Callable[[], "SetupTask"]] = None,
        _predict_task_cls: Optional[
            Callable[[schema.PredictionRequest], "PredictTask"]
        ] = None,
    ) -> None:
        self._setup_task_cls = _setup_task_cls or SetupTask
        self._predict_task_cls = _predict_task_cls or create_predict_task
    ...
    def setup(self) -> "SetupTask":
        ...
        self._setup_task = self._setup_task_cls()
    ...
    def predict(
        ...
        self._predict_task = self._predict_task_cls(prediction, **task_kwargs)
