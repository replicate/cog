...
class ClientManager:
    ...
    # that would mutate the input payload. ideally, we would download files concurrently
    # and handle files in dicts and other collections
    # however, in the meantime, this is handled in the runner predict method
