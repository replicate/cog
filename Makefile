...
deploy: clean
	...
	gcloud run deploy modelserver --region us-central1 --image "$(DOCKER_TAG)" --platform managed --allow-unauthenticated --args=server --service-account=modelstorage@replicate.iam.gserviceaccount.com
